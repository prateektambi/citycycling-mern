...
import { Menu, X, Bike, ShoppingCart, LogOut, PlusCircle, Package, LayoutDashboard, Users, FileText, MessageSquare } from 'lucide-react'; // Optional: Use lucide-react for icons
...
const AdminLayout = () => {
  ...
  const navItems = [
    ...
    { name: 'Quotation Gen', path: '/admin/quotations', icon: <FileText size={20}/> },
    { name: 'WhatsApp Digest', path: '/admin/whatsapp', icon: <MessageSquare size={20}/> },
